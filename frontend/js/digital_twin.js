...
export class DigitalTwinViewer {
    ...
    updatePose(payload) {
        this._post({ type: 'update_pose', payload: payload || {} });
    }
    ...
    toggleInfoPanel() { this._post({ type: 'cnc_control', action: 'info_toggle' }); }
    showInfoPanel() { this._post({ type: 'cnc_control', action: 'info_show' }); }
    hideInfoPanel() { this._post({ type: 'cnc_control', action: 'info_hide' }); }
